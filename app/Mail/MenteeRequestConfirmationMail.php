...
class MenteeRequestConfirmationMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Sers Chborng | Your appointment request to meet '. Mentor::getMentorName($this->appointment->mentor_id),
        );
    }
    ...
    {
        return new Content(
            view: 'mail.request_confirmation',
            with: [
