...
class AppointmentAcceptedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Sers Chborng | Appointment Accepted Between '. Mentor::getMentorName($this->appointment->mentor_id) .' and '. User::getUsername($this->appointment->mentee_id),
        );
    }
    ...
    {
        return new Content(
            view: 'mail.appointment_accepted',
            with: [
